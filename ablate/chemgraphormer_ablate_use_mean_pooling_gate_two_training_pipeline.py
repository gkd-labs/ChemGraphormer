...
from model.chemgraphormer_ablate_use_mean_pooling_gate_two import ChemGraphormerClassifier
...
def run_use_mean_pooling_gate_two_ablation(args):
    """
    ...
    no_improve_epochs = 0
    best_ckpt_path = os.path.join(args.ckpt_dir, "chemgraphormer_mean_pooling_gate_two_ablation_best_model.pt")
