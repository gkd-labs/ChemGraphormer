...
def load_qm9() -> pd.DataFrame:
    ...
    Downloads the raw CSV directly from the Hub rather than going through
    datasets.load_dataset(), since some datasets/huggingface_hub version
    combinations fail to resolve this repo's data files automatically.
    """
